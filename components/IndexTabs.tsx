      ...
      <TabsContent value="INDEX_LEVELS" keepMounted>
        ...
        >
          ...
          <div className="overflow-x-auto mb-4">
            <TabsList className="flex h-auto gap-1 bg-zinc-100 rounded-lg p-1 w-max min-w-full">
              <TabsTrigger
                value="OVERVIEW"
                className="rounded-md px-4 py-1.5 text-xs font-medium data-active:bg-white data-active:text-zinc-900 data-active:shadow-sm text-zinc-600 hover:text-zinc-900 transition-colors whitespace-nowrap"
              >
                Overview
              </TabsTrigger>
              {INDEX_META.map((meta) => (
